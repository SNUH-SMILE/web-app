...
public class ItemSaveVO extends BaseDefaultVO {
     ...
     * 측정항목 ID
     */
    @NotNull(message = "{validation.null.itemId}", groups = { VoValidationGroups.modify.class, VoValidationGroups.delete.class })
    private String itemId;

    /**
     * 측정항목명
     */
    @NotNull(message = "{validation.null.itemNm}", groups = { VoValidationGroups.add.class, VoValidationGroups.modify.class })
     ...
     * 측정항목단위
     */
    @NotNull(message = "{validation.null.itemUnit}", groups = { VoValidationGroups.add.class, VoValidationGroups.modify.class })
